...
- [x] Fresh automated verification on 2026-08-02 passed both miner-recovery focused paths twice at 1/1 each (plus the verified wildcard at 2/2), `runHarnesses` (176 actionable tasks: 162 executed and 14 up-to-date), two fresh-world NeoForge runs with all 92 required GameTests passing, `buildAll` for both Fabric and NeoForge (186 actionable tasks: 166 executed and 20 up-to-date), and `git diff --check`.
